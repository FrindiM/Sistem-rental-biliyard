 ...
 <?php
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_GET['barang']) && $_GET['barang'] == 'edit') {
		...
		echo '<script>window.location="admin.php?page=free/&id=' . $id . '&success=edit-data"</script>';
		exit();
	}
	?>


 <a href="admin.php" class="btn btn-primary mb-3"><i class="fa fa-angle-left"></i> Balik </a>
 <h4>Edit User</h4>
 ...
 <div class="card card-body">
 	<div class="table-responsive">
 		<table class="table table-striped">
 			<form action="admin.php?page=free&barang=edit&id=<?php echo $baris['id']; ?>" method="POST">
 				<tr>
