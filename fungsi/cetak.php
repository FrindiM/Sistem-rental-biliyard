...
if (!empty($_GET['cari'])) {
    ...
    $sql2 = "SELECT * FROM rekap_tambahan WHERE DATE(tgl) >= '$periode' AND DATE(tgl) < LAST_DAY('$periode') + INTERVAL 1 DAY";
    ...
    $hari = $_GET['tgl'];
    $kasir = $_GET['kasir'];
    $sql = "SELECT * FROM waktu_meja WHERE DATE(tanggal) = '$hari' AND kasir = '$kasir'";
    $sql2 = "SELECT * FROM rekap_tambahan WHERE DATE(tgl) = '$hari' AND nama_kasir = '$kasir'";
} else {
